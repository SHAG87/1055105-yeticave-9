        ...
        <div class="form__container-two">
            ...
            <div class="form__item <?= isset($errors['category']) ? 'form__item--invalid' : '';?>">
                ...
                <select id = "category" name = "category">
                    <?php foreach ($categories as $category) : ?>
                        <option value="<?=$category['id']?>" <?= (isset($lot['category']) && $category['id'] === (int) $lot['category']) ? 'selected' : '';?>><?=esc($category['name']);?></option>
                    <? endforeach; ?>
                </select>
                <span class="form__error" ><?=$errors['category'] ?? 'Выберите категорию';?></span>
            </div>
        </div>
