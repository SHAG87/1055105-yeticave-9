    ...
    <div class="lot-item__content">
        <div class="lot-item__left">
            <div class="lot-item__image">
                <img src="<?=esc_strong($img_url)?>" width="730" height="548" alt="">
            </div>
            <p class="lot-item__category">Категория: <span><?=esc_strong($categories) ?></span></p>
            <p class="lot-item__description"><?=esc($description) ?></p>
        </div>
